...
Il testo dei dati selezionati, precedentemente scaricato in locale in formato `.txt`, è stato caricato su [**VS CODE**](https://vscode.dev/?vscode-lang=it-it) e marcato in TEI. 
